...
class _$EmployeeImpl implements _Employee {
  ...
  @override
  String toString() {
    return 'Employee(id: $id, name: $name, cashierId: $cashierId, businessId: $businessId, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, name, cashierId, businessId, createdAt, updatedAt);
...
abstract class _Employee implements Employee {
  const factory _Employee(
      ...
      required final DateTime updatedAt}) = _$EmployeeImpl;
