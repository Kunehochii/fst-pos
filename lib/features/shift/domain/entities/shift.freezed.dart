...
mixin _$Shift {
  ...
  List<ShiftEmployee> get employees => throw _privateConstructorUsedError;
...
class _$ShiftImpl extends _Shift {
  const _$ShiftImpl(
      ...
      this.endTime,
      required final List<ShiftEmployee> employees,
  ...
  final List<ShiftEmployee> _employees;
  @override
  List<ShiftEmployee> get employees {
  ...
  @override
  String toString() {
    return 'Shift(id: $id, cashierId: $cashierId, startTime: $startTime, endTime: $endTime, employees: $employees, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
...
abstract class _Shift extends Shift {
  const factory _Shift(
      ...
      required final DateTime updatedAt}) = _$ShiftImpl;
